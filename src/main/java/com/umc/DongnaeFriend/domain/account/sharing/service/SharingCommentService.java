...
public class SharingCommentService {
    ...
    public String newComment(Long sharing_board_id, ReqSharingCommentDto reqSharingCommentDto) {
        // !임시! 유저 가져오기
        User user = sharingCommentRepository.findByUserId(1L);

        // 게시판 가져오기
        SharingBoard sharingBoard = sharingCommentRepository.findBySharingBoardId(sharing_board_id);
